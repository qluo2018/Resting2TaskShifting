...
% %  Main loop
datapath = './fMRIdata/rest/Normal/';     % direction of subject fMRI data
...
for i = 1:nSub
    ...
    % % % % save GCA result
    y_Write(path_ROI2Vox,hdr,[workpath,'path_ROI2_ROI2Vox.nii']);
    y_Write(path_Vox2ROI,hdr,[workpath,'path_ROI2_Vox2ROI.nii']);
